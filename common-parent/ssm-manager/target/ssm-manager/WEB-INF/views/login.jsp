...
<html>
	<head>
		...
		<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/login/layui/css/layui.css" media="all"/>
		<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/login/css/login.css" media="all"/>
		<style>
			/* 覆盖原框架样式 */
	...
	<body>
		...
		<div class="layui-fluid">
			<div class="layui-row layui-col-space15">
				<div class="layui-col-sm12 layui-col-md12 zyl_mar_01">
					<blockquote class="layui-elem-quote">实验报告网络在线管理平台</blockquote>
				</div>
			</div>
		</div>
		<!-- Head End -->
		...
		<div class="zyl_lofo_main">
			<fieldset class="layui-elem-field layui-field-title zyl_mar_02">
				<legend>欢迎登陆 - 实验报告网络在线管理平台</legend>
			</fieldset>
			<div class="layui-row layui-col-space15">
		...
		<!-- Jquery Js -->
		<script type="text/javascript" src="${pageContext.servletContext.contextPath}/login/js/jquery.min.js"></script>
		<!-- Layui Js -->
		<script type="text/javascript" src="${pageContext.servletContext.contextPath}/login/layui/layui.js"></script>
		<!-- Jqarticle Js -->
		<script type="text/javascript" src="${pageContext.servletContext.contextPath}/login/assembly/jqarticle/jparticle.min.js"></script>
		<!-- ZylVerificationCode Js-->
		<script type="text/javascript" src="${pageContext.servletContext.contextPath}/login/assembly/zylVerificationCode/zylVerificationCode.js"></script>
		<script>
